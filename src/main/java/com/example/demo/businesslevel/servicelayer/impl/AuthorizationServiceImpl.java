...
import com.example.demo.businesslevel.servicelayer.AuthorizationService;
import com.example.demo.businesslevel.servicelayer.MailSender;
import com.example.demo.businesslevel.servicelayer.OrderService;
import com.example.demo.daolevel.repositories.UserRepository;
import com.example.demo.businesslevel.domainlayer.Role;
import com.example.demo.businesslevel.validationlayer.AuthorizationValidator;
...
public class AuthorizationServiceImpl implements AuthorizationService {
    ...
    public String save(User user, BindingResult bindingResult, Model model) {
        ...
        mailSenderImpl.send(user.getEmail(), "Активация учётной записи", message);
        return "redirect:/main";
    }
    ...
    public String forgetPasswordAction(User user, String email, Model model) {
        ...
        mailSenderImpl.send(userFromDB.getEmail(), "Восстановление пароля", message);
